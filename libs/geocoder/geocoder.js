if (function() {
    ...
    b.GeocoderJS = a;
}(), "function" == typeof define && define.amd && define(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require) var GeocoderJS = require("../GeocoderJS.ui");
...
}(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require) var GeocoderJS = require("./GeocoderJS.ui");
...
if (function(a) {
    ...
    var GeocoderJS = require("../GeocoderJS.ui");
    require("../ExternalURILoader.ui");
}
...
if (function(a, b) {
    ...
    var GeocoderJS = require("../GeocoderJS.ui");
    require("../Geocoded.ui"), require("../providers/ProviderBase.ui");
}
...
if (function(a) {
    ...
    var GeocoderJS = require("../GeocoderJS.ui");
    require("../Geocoded.ui"), require("../ExternalURILoader.ui"), require("../providers/ProviderBase.ui");
}
