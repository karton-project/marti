...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
    ...
    if (a in goog.Dependency.callbackMap_) {
        ...
        c.apply(void 0, d)
    } else throw Error("Callback key " + a + " does not exist (was base.ui loaded more than once?).");
    ...
    } else goog.logToConsole_("Cannot use default debug loader outside of HTML documents."), "deps.js" == this.relativePath ? (goog.logToConsole_("Consider setting CLOSURE_IMPORT_SCRIPT before loading base.ui, or setting CLOSURE_NO_DEPS to true."), a.loaded()) : a.pause()
