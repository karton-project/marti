...
// Chart Types
    ...
    _tt_category = "Click on these boxes to switch between categories.";
    _tt_blocks = "Drag these programming cards to coding area to start programming";
    _tt_coding = "Enter required inputs to complete programming tasks.";
    _tt_output = "See the final output here after running the program.ß";
