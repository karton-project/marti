(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        dragula([$('left-copy-1tomany'), $('right-copy-1tomany')], {
            ...
            .on('drop', function (el) {
                containerBlockIds = getListOfElementIDs();
                el.querySelector('#' + el.id.substring(0, el.id.length - 6) + "_modal").id =
                    el.id.substring(0, el.id.length - 6) + cnt + "_modal";

                el.querySelector('#' + el.id.substring(0, el.id.length - 6)).id =
                    el.id.substring(0, el.id.length - 6) + cnt;
